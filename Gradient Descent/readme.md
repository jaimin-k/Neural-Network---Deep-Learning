...
Thus, learning from previously labeled data to develop a linear model that fits the data with minimal error using Stochastic gradient descent algorithm.

Implementation- https://youtu.be/oxOvclcOJB4
